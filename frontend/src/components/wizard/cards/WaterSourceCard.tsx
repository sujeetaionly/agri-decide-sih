...
export const WaterSourceCard: React.FC = () => {
  ...
  const WATER_LEVELS = [
    {
      ...
      source: 'CANAL',
      title: t('waterHigh'),
      subtitle: 'नहर या बारहमासी ट्यूबवेल • सभी फसलों के लिए पर्याप्त',
      icon: 'water',
    ...
    },
    {
      ...
      subtitle: 'सिंचाई का कोई साधन नहीं • केवल बारिश पर निर्भर',
      icon: 'cloud_queue',
  ...
  const handleAudio = () => {
    ...
    const msg = `${t('card3Title')}। ${t('card3Sub')}। वर्तमान चयन ${selectedObj?.title || 'मध्यम पानी'} है।`;
  ...
  return (
    <div className="space-y-6 animate-fadeIn pb-36">
      ...
      <div className="fixed bottom-16 inset-x-0 z-40 px-4 max-w-md mx-auto flex gap-3">
        ...
        >
          <span>{t('continue')} (पिछली फसल)</span>
